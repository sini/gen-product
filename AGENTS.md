...
exercised in this run. The `relations` join (membership enumeration strategy 2, `lib/membership.nix:132-156`)
...
holds full **coords**, `relations` are `{ dims; pairs; }` conjoined by natural join (`lib/membership.nix:39-65`).
...
| Trap                                                                                                                                                                                                                                                                                                                                                                                                                                             | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A restriction's `cells` field holds **coords**, not cellIds — handing it a cellId aborts evaluation, and `tryEval` does **not** catch it                                                                                                                                                                                                                                                                                                         | `lib/membership.nix:61`; `gp.restrict pg { cells = [ cid ]; }` ⇒ `error: expected a set but found a string: "[\"H_a\",\"U_s\"]"`, escaping `tryEval`. Positive control, same run: `cells = [ { host = hosts.H_a; user = users.U_s; } { host = hosts.H_c; user = users.U_v; } ]` ⇒ 2 nodes. Test: `test-clause1-cells` (`ci/tests/restrict-membership.nix`)                                                                                                                                                                                                                                                                                                                                                          |
...
| A predicate-only restriction keeps adjacency pointwise but enumerates the **full** product (strategy 3)                                                                                                                                                                                                                                                                                                                                          | `lib/membership.nix:166-170`; under a throwing-`nodes` factor `.edges cid` ⇒ `true` while `.nodes` ⇒ threw. Test: `test-predicate-adjacency-no-enumerate` (`ci/tests/restrict-membership.nix`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Enumeration is pinned row-major in declared factor order, last dimension fastest                                                                                                                                                                                                                                                                                                                                                                 | `lib/membership.nix:84-93`; `gp.cells pg` ⇒ `H_a/U_s, H_a/U_v, H_b/U_s, H_b/U_v, H_c/U_s, H_c/U_v` (by `id_hash`). Test: `test-cells-row-major` (`ci/tests/enumeration-order.nix`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
